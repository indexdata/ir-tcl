...
set {profile(ztest)} {{test server} localhost 9999 {} 60000 60000 tcpip dummy 1 {} 1 Z39 3}
...
set {profile(Default)} {{} {} {210} {} 16384 8192 tcpip {} 1 {} {} {} 30}
...
set {profile(WAIS Thingy)} {{Wais Thingy} 131.84.1.14 2001 {} 16384 8192 tcpip /wais/indexes/locator 1 {} {} Z39 29}
...
set queryTypes {Simple phrase WAIS}
set queryButtons {{{I 3} {I 0} {I 1} {I 2}} {{I 0} {I 1} {I 0}} {{I 0}}}
set queryInfo {{ {Title {1=4}} {Author {1=1}} {Subject {1=21}} {Any {1=1016}} {Query 1=1016 2=102} {Title-rank 1=4 2=102} {Date/time 1=1012}} {{Title 1=4 4=1 6=2} {Author 1=1003 4=1 6=2} {ISBN 1=7} {ISSN 1=8} {Year 1=30 4=4 6=2} {Any {}}} {{General 1=1016 2=102 4=105}}}
